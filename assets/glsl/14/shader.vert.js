...
void main () {
  ...
  pos.x += noise(pos.xy * 0.2 + u_time*1.) * 10.0;
  pos.x += noise(pos.xy * 0.3 + u_time*1.) * 2.0;
  pos.x += noise(pos.xy * 0.05 + u_time*1.) * 10.0;

  pos.y += noise(pos.xy * 0.2 + u_time*1.) * 10.0;
  pos.y += noise(pos.xy * 0.3 + u_time*1.) * 2.0;
  pos.y += noise(pos.xy * 0.05 + u_time*1.) * 10.0;

  // pos.x += 20. + u_time*1000.;
